...
//)
//
//func importRecords(inputType inputType, ldifInput string, ignoreAttr []string) (entries, error) {
//	var (
//		readErr  error
//		parseErr error
//		wg       sync.WaitGroup
...
//		go readStr(ldifInput, ignoreAttr, queue, &wg, &readErr)
//	default: // it's a file
//		go readFile(ldifInput, ignoreAttr, queue, &wg, &readErr)
//	}
//
